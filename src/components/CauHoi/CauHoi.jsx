...
const CauHoi = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => (
                <div>
                    ...
                    <span>
                        Họ và tên: {record?.lastName} {record?.firstName}
                    </span>
                </div>
            ),
            // width: 100
        ...
        },
        {
            ...
            key: "ttt",
            render: (text, record) => {
                const truncatedText = record?.cauTraLoi
                    ? record.cauTraLoi.length > 50 // Giới hạn số ký tự (ví dụ: 50)
                        ? `${record.cauTraLoi.substring(0, 50)}...`
                        : record.cauTraLoi
                    : "Chưa trả lời";
                    ...
                    pagination={{
                        ...
                        showTotal: (total, range) => {
                            return (
                                <div>
                                    {" "}
                                    {range[0]}-{range[1]} trên {total} câu hỏi
                                </div>
                            );
                        },
                    }}
